...
if __name__ == '__main__':
    ...
    train_features, test_features, train_classes, test_classes = get_train_test_data(train_folder, test_folder, 0, 0, 0)
    ...
    output_file.write("NB+UB,"+"CountVectorizer,"+format(nb_prediction_precision_score, '.3f')+","+format(nb_prediction_recall_score, '.3f')+","+format(nb_prediction_f1_score, '.3f'))
    output_file.write("\n")
    
    train_features, test_features, train_classes, test_classes = get_train_test_data(train_folder, test_folder, 1, 0, 0)
    nb_prediction = classification(train_features, test_features, train_classes, a_val)    
    nb_prediction_precision_score = precision_score(test_classes, nb_prediction, average='macro')
    nb_prediction_recall_score = recall_score(test_classes, nb_prediction, average='macro')
    nb_prediction_f1_score = f1_score(test_classes, nb_prediction, average='macro')
    output_file.write("NB+UB,"+"TFIDFVectorizer,"+format(nb_prediction_precision_score, '.3f')+","+format(nb_prediction_recall_score, '.3f')+","+format(nb_prediction_f1_score, '.3f'))
    output_file.write("\n")
    
    train_features, test_features, train_classes, test_classes = get_train_test_data(train_folder, test_folder, 0, 0, 1)
    nb_prediction = classification(train_features, test_features, train_classes, a_val)    
    nb_prediction_precision_score = precision_score(test_classes, nb_prediction, average='macro')
    nb_prediction_recall_score = recall_score(test_classes, nb_prediction, average='macro')
    nb_prediction_f1_score = f1_score(test_classes, nb_prediction, average='macro')
    output_file.write("NB+UB,"+"CountVectorizer+StopWord,"+format(nb_prediction_precision_score, '.3f')+","+format(nb_prediction_recall_score, '.3f')+","+format(nb_prediction_f1_score, '.3f'))
    output_file.write("\n")
    ...
    nb_prediction_recall_score = recall_score(test_classes, nb_prediction, average='macro')
    nb_prediction_f1_score = f1_score(test_classes, nb_prediction, average='macro')
    output_file.write("NB+UB,"+"TFIDFVectorizer+StopWord,"+format(nb_prediction_precision_score, '.3f')+","+format(nb_prediction_recall_score, '.3f')+","+format(nb_prediction_f1_score, '.3f'))
    output_file.write("\n")
    
    train_features, test_features, train_classes, test_classes = get_train_test_data(train_folder, test_folder, 0, 1, 1)
    nb_prediction = classification(train_features, test_features, train_classes, a_val)    
    nb_prediction_precision_score = precision_score(test_classes, nb_prediction, average='macro')
    nb_prediction_recall_score = recall_score(test_classes, nb_prediction, average='macro')
    nb_prediction_f1_score = f1_score(test_classes, nb_prediction, average='macro')
    output_file.write("NB+UB,"+"CountVectorizer+StopWord+Stemming,"+format(nb_prediction_precision_score, '.3f')+","+format(nb_prediction_recall_score, '.3f')+","+format(nb_prediction_f1_score, '.3f'))
    output_file.write("\n")
    
    train_features, test_features, train_classes, test_classes = get_train_test_data(train_folder, test_folder, 1, 1, 1)
    nb_prediction = classification(train_features, test_features, train_classes, a_val)    
    nb_prediction_precision_score = precision_score(test_classes, nb_prediction, average='macro')
    nb_prediction_recall_score = recall_score(test_classes, nb_prediction, average='macro')
    nb_prediction_f1_score = f1_score(test_classes, nb_prediction, average='macro')
    output_file.write("NB+UB,"+"TFIDFVectorizer+StopWord+Stemming,"+format(nb_prediction_precision_score, '.3f')+","+format(nb_prediction_recall_score, '.3f')+","+format(nb_prediction_f1_score, '.3f'))
    output_file.write("\n")
    
    train_features, test_features, train_classes, test_classes = get_train_test_data(train_folder, test_folder, 0, 1, 0)
    nb_prediction = classification(train_features, test_features, train_classes, a_val)    
    nb_prediction_precision_score = precision_score(test_classes, nb_prediction, average='macro')
    nb_prediction_recall_score = recall_score(test_classes, nb_prediction, average='macro')
    nb_prediction_f1_score = f1_score(test_classes, nb_prediction, average='macro')
    output_file.write("NB+UB,"+"CountVectorizer+Stemming,"+format(nb_prediction_precision_score, '.3f')+","+format(nb_prediction_recall_score, '.3f')+","+format(nb_prediction_f1_score, '.3f'))
    output_file.write("\n")
    
    train_features, test_features, train_classes, test_classes = get_train_test_data(train_folder, test_folder, 1, 1, 0)
    nb_prediction = classification(train_features, test_features, train_classes, a_val)    
    nb_prediction_precision_score = precision_score(test_classes, nb_prediction, average='macro')
    nb_prediction_recall_score = recall_score(test_classes, nb_prediction, average='macro')
    nb_prediction_f1_score = f1_score(test_classes, nb_prediction, average='macro')
    output_file.write("NB+UB,"+"TFIDFVectorizer+Stemming,"+format(nb_prediction_precision_score, '.3f')+","+format(nb_prediction_recall_score, '.3f')+","+format(nb_prediction_f1_score, '.3f'))
